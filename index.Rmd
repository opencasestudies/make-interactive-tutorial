...
This tutorial will guide you through how to take an existing static case and make int interactive using a method where the entire case study becomes a single `learnr` tutorial hosted as one Shiny app.
...
1) Create your case study as a `learnr` tutorial
...
2) Create individual shiny apps for each exercise and then add these to your typical case study using iframes
...
If you prefer option 1, continue with this tutorial. If you prefer option 2, check out this [tutorial](https://desiree.rbind.io/blog/learnr-iframes/).
