...
This tutorial will guide you through how to create interactive case studies.
...
1) create individual shiny apps for each exercise and then add these to your typical case study
...
I will use some examples to explain this. **A quick way to find where it needs to be modified is to do `CTRL + F` and search for `here(`**
